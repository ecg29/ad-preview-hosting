...
addListeners = function (e) {
    ...
    document.querySelector('#replay_btn').addEventListener('click', function (e) {
        ...
        slideIndex = 1;
        previousImg = 0;
        gsap.set('#background-endframe', { clipPath: 'inset(0 0 0 310px)' });
...
addAnimation = function (e) {
    ...
    tl.to('#logo-wrapper', { autoAlpha: 1, duration: 0.5 })
        ...
        .to('#logo-container', { x: -135, y: -30, scale: 0.55, delay: 1, duration: 1.7, ease: "power3.out" }, "logoSplit")
        ...
        .to('.slideshow-container', {
            clipPath: 'inset(0 0 0 0px)', delay: 1, duration: 1.3, ease: 'sine.out', onStart: function () {
                ...
                imgAnim.to(document.querySelectorAll('.slide-panel')[0], {
                    rotation: 0.1, delay: 0.3, duration: 3, x: '-10%', ease: 'power0.none', onComplete: function () {
                    }
                })
...
function showSlides(n, direction) {
    ...
    if (direction == 'right') {
        ...
        tl.fromTo(slides[slideIndex - 1], .8, { x: 300, scale: .8, opacity: 0, zIndex: 1 }, {
            x: 0, scale: 1, opacity: 1, onComplete: function () { onAnim = false }, onStart: function () {
...
function rotateOnce() {
    ...
    if (previousImg == 2 && !firstRotate) {
        ...
        gsap.to('#background-endframe', {
            delay: 5, clipPath: 'inset(0 0 0 0px)', duration: 1.3, ease: 'sine.out', onComplete: function () {
