        ...
        .to('.slideshow-container', {
            clipPath: 'inset(0px 0 0 0)', delay: 1, duration: 1.3, ease: 'sine.out', onStart: function () {
                ...
                imgAnim.to(document.querySelectorAll('.slide-panel')[0], {
                    rotation: 0.1, duration: 3, x: '-12.5%', ease: 'power0.none', onComplete: function () {
                    }
                })
...
function showSlides(n, direction) {
    ...
    if (direction == 'right') {
        ...
        tl.fromTo(slides[slideIndex - 1], .8, { rotation: 0.1, x: 300, scale: .8, autoAlpha: 0, zIndex: 1 }, {
            x: 0, scale: 1, autoAlpha: 1, onComplete: function () {
                ...
                if (slideIndex != 1) {
                    ...
                    imgAnim.to(document.querySelectorAll('.slide-panel')[slideIndex - 1], {
                        rotation: 0.1, delay: 0.3, duration: 3, x: '-12.5%', ease: 'power0.none', onComplete: function () {
                        }
                    })
